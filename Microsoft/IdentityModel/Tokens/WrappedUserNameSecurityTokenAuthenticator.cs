...
// Type: Microsoft.IdentityModel.Tokens.WrappedUserNameSecurityTokenAuthenticator
  ...
  internal class WrappedUserNameSecurityTokenAuthenticator : UserNameSecurityTokenAuthenticator
  {
      ...
      ExceptionMapper exceptionMapper)
    {
      if (wrappedUserNameSecurityTokenHandler == null)
        throw DiagnosticUtil.ExceptionUtil.ThrowHelperArgumentNull(nameof (wrappedUserNameSecurityTokenHandler));
    ...
    protected override ReadOnlyCollection<IAuthorizationPolicy> ValidateUserNamePasswordCore(
      ...
      string password)
    {
      throw DiagnosticUtil.ExceptionUtil.ThrowHelperError((Exception) new NotImplementedException(Microsoft.IdentityModel.SR.GetString("ID4008", (object) nameof (WrappedUserNameSecurityTokenAuthenticator), (object) nameof (ValidateUserNamePasswordCore))));
    }
  }
}
