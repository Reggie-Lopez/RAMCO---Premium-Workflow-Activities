...
// Type: Microsoft.IdentityModel.Protocols.WSFederation.RstParameterNotAcceptedFaultException
...
namespace Microsoft.IdentityModel.Protocols.WSFederation
{
  ...
  public class RstParameterNotAcceptedFaultException : RequestFaultException
  {
    public RstParameterNotAcceptedFaultException(string soapNamespace)
      : this(soapNamespace, new FaultReason(Microsoft.IdentityModel.SR.GetString("ID3239")))
    {
    }
