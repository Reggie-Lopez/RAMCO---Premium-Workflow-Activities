...
// Type: Microsoft.IdentityModel.Protocols.WSFederation.UnsupportedEncodingFaultException
...
namespace Microsoft.IdentityModel.Protocols.WSFederation
{
  ...
  public class UnsupportedEncodingFaultException : RequestFaultException
  {
    public UnsupportedEncodingFaultException(string soapNamespace)
      : this(soapNamespace, new FaultReason(Microsoft.IdentityModel.SR.GetString("ID3241")))
    {
    }
