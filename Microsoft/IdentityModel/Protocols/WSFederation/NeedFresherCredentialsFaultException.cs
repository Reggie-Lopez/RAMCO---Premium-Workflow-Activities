...
// Type: Microsoft.IdentityModel.Protocols.WSFederation.NeedFresherCredentialsFaultException
...
namespace Microsoft.IdentityModel.Protocols.WSFederation
{
  ...
  public class NeedFresherCredentialsFaultException : RequestFaultException
  {
    public NeedFresherCredentialsFaultException(string soapNamespace)
      : this(soapNamespace, new FaultReason(Microsoft.IdentityModel.SR.GetString("ID3237")))
    {
    }
