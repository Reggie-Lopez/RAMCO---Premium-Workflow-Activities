...
// Type: Microsoft.IdentityModel.Protocols.WSFederation.NoMatchInScopeFaultException
...
namespace Microsoft.IdentityModel.Protocols.WSFederation
{
  ...
  public class NoMatchInScopeFaultException : RequestFaultException
  {
    public NoMatchInScopeFaultException(string soapNamespace)
      : this(soapNamespace, new FaultReason(Microsoft.IdentityModel.SR.GetString("ID3236")))
    {
    }
