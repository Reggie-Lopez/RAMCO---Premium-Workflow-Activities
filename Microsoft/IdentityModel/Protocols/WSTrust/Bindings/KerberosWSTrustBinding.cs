...
// Type: Microsoft.IdentityModel.Protocols.WSTrust.Bindings.KerberosWSTrustBinding
...
namespace Microsoft.IdentityModel.Protocols.WSTrust.Bindings
{
  ...
  public class KerberosWSTrustBinding : WSTrustBindingBase
  {
    ...
    protected override SecurityBindingElement CreateSecurityBindingElement()
    {
      ...
      return SecurityMode.TransportWithMessageCredential == this.SecurityMode ? (SecurityBindingElement) SecurityBindingElement.CreateKerberosOverTransportBindingElement() : (SecurityBindingElement) null;
    }
