...
// Type: Microsoft.IdentityModel.Protocols.WSIdentity.UnknownInformationCardReferenceException
...
namespace Microsoft.IdentityModel.Protocols.WSIdentity
{
  ...
  public class UnknownInformationCardReferenceException : Exception
  {
    public UnknownInformationCardReferenceException()
      : base(Microsoft.IdentityModel.SR.GetString("ID2045"))
    {
    }
    ...
    protected UnknownInformationCardReferenceException(
