...
// Type: Microsoft.IdentityModel.Protocols.WSIdentity.InformationCardRefreshRequiredFaultException
...
namespace Microsoft.IdentityModel.Protocols.WSIdentity
{
  ...
  public class InformationCardRefreshRequiredFaultException : RequestFaultException
  {
    public InformationCardRefreshRequiredFaultException(string soapNamespace)
      : this(soapNamespace, new FaultReason(Microsoft.IdentityModel.SR.GetString("ID2047")))
    {
    }
