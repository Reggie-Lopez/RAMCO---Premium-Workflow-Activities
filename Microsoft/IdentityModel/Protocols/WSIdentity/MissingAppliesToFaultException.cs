...
// Type: Microsoft.IdentityModel.Protocols.WSIdentity.MissingAppliesToFaultException
...
namespace Microsoft.IdentityModel.Protocols.WSIdentity
{
  ...
  public class MissingAppliesToFaultException : RequestFaultException
  {
    public MissingAppliesToFaultException(string soapNamespace)
      : this(soapNamespace, new FaultReason(Microsoft.IdentityModel.SR.GetString("ID2043")))
    {
    }
