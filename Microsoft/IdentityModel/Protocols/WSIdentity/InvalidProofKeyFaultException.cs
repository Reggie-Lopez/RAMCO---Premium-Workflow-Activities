...
// Type: Microsoft.IdentityModel.Protocols.WSIdentity.InvalidProofKeyFaultException
...
namespace Microsoft.IdentityModel.Protocols.WSIdentity
{
  ...
  public class InvalidProofKeyFaultException : RequestFaultException
  {
    public InvalidProofKeyFaultException(string soapNamespace)
      : this(soapNamespace, new FaultReason(Microsoft.IdentityModel.SR.GetString("ID2044")))
    {
    }
