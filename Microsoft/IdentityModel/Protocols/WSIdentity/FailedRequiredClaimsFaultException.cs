...
// Type: Microsoft.IdentityModel.Protocols.WSIdentity.FailedRequiredClaimsFaultException
...
namespace Microsoft.IdentityModel.Protocols.WSIdentity
{
  ...
  public class FailedRequiredClaimsFaultException : RequestFaultException
  {
    public FailedRequiredClaimsFaultException(string soapNamespace)
      : this(soapNamespace, new FaultReason(Microsoft.IdentityModel.SR.GetString("ID2046")))
    {
    }
