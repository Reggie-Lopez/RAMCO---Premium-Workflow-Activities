...
// Type: Microsoft.IdentityModel.Protocols.WSIdentity.InternalErrorFaultException
...
namespace Microsoft.IdentityModel.Protocols.WSIdentity
{
  ...
  public class InternalErrorFaultException : RequestFaultException
  {
    public InternalErrorFaultException(string soapNamespace)
      : this(soapNamespace, new FaultReason(Microsoft.IdentityModel.SR.GetString("ID2101")))
    {
    }
