...
// Type: Microsoft.IdentityModel.Protocols.WSIdentity.UnsupportedSignatureFormatFaultException
...
namespace Microsoft.IdentityModel.Protocols.WSIdentity
{
  ...
  public class UnsupportedSignatureFormatFaultException : RequestFaultException
  {
    public UnsupportedSignatureFormatFaultException(string soapNamespace)
      : this(soapNamespace, new FaultReason(Microsoft.IdentityModel.SR.GetString("ID2104")))
    {
    }
