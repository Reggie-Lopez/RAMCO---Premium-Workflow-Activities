...
// Type: Microsoft.IdentityModel.Configuration.ConfigurationStrings
...
namespace Microsoft.IdentityModel.Configuration
{
  internal static class ConfigurationStrings
  {
    ...
    public const string DefaultConfigurationElementName = "";
    ...
    public const string MicrosoftIdentityModel = "microsoft.identityModel";
    ...
    public const string ReplayCache = "replayCache";
    ...
    public const string SaveBootstrapTokens = "saveBootstrapTokens";
