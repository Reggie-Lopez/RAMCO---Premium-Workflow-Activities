...
{
  public class GetStoreLocationbyGUID : BaseWorkflow
  {
    [RequiredArgument]
    ...
    {
      EntityReference entityReference = new EntityReference("ramco_storelocation", Guid.Parse(this.RecordId.Get((ActivityContext) context.CodeActivityContext)));
      this.StoreLocationDefinedRecordId.Set((ActivityContext) context.CodeActivityContext, entityReference);
    }
