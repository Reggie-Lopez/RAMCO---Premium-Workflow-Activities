...
namespace Remotion.Linq.Parsing.Structure.IntermediateModel
{
  ...
  {
    public static IEnumerable<MethodInfo> GetSupportedMethods() => ReflectionUtility.EnumerableAndQueryableMethods.WhereNameMatches("First").Concat<MethodInfo>(ReflectionUtility.EnumerableAndQueryableMethods.WhereNameMatches("FirstOrDefault"));

    public FirstExpressionNode(
