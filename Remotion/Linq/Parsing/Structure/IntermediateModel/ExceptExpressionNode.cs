...
// Type: Remotion.Linq.Parsing.Structure.IntermediateModel.ExceptExpressionNode
...
namespace Remotion.Linq.Parsing.Structure.IntermediateModel
{
  ...
  public sealed class ExceptExpressionNode : ResultOperatorExpressionNodeBase
  {
    ...
    public static IEnumerable<MethodInfo> GetSupportedMethods() => ReflectionUtility.EnumerableAndQueryableMethods.WhereNameMatches("Except").WithoutEqualityComparer();
    ...
    protected override ResultOperatorBase CreateResultOperator(
      ClauseGenerationContext clauseGenerationContext)
    {
      return (ResultOperatorBase) new ExceptResultOperator(this._source2);
    }
  }
}
