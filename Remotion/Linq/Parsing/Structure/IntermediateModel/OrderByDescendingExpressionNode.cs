...
// Type: Remotion.Linq.Parsing.Structure.IntermediateModel.OrderByDescendingExpressionNode
...
namespace Remotion.Linq.Parsing.Structure.IntermediateModel
{
  ...
  public sealed class OrderByDescendingExpressionNode : MethodCallExpressionNodeBase
  {
    ...
    public static IEnumerable<MethodInfo> GetSupportedMethods() => ReflectionUtility.EnumerableAndQueryableMethods.WhereNameMatches("OrderByDescending").WithoutComparer();

    public OrderByDescendingExpressionNode(
      ...
      ClauseGenerationContext clauseGenerationContext)
    {
      ...
      orderByClause.Orderings.Add(new Ordering(this.GetResolvedKeySelector(clauseGenerationContext), OrderingDirection.Desc));
