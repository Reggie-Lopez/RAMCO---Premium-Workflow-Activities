...
namespace Remotion.Linq.Parsing.Structure.IntermediateModel
{
  ...
  public sealed class SkipExpressionNode : ResultOperatorExpressionNodeBase
  {
    ...
    public static IEnumerable<MethodInfo> GetSupportedMethods() => ReflectionUtility.EnumerableAndQueryableMethods.WhereNameMatches("Skip");
    ...
    protected override ResultOperatorBase CreateResultOperator(
      ClauseGenerationContext clauseGenerationContext)
    {
      return (ResultOperatorBase) new SkipResultOperator(this._count);
    }
  }
}
