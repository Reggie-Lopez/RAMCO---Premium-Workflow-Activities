...
// Type: Remotion.Linq.Parsing.Structure.IntermediateModel.LastExpressionNode
...
namespace Remotion.Linq.Parsing.Structure.IntermediateModel
{
  ...
  {
    public static IEnumerable<MethodInfo> GetSupportedMethods() => ReflectionUtility.EnumerableAndQueryableMethods.WhereNameMatches("Last").Concat<MethodInfo>(ReflectionUtility.EnumerableAndQueryableMethods.WhereNameMatches("LastOrDefault"));
    ...
    protected override ResultOperatorBase CreateResultOperator(
      ClauseGenerationContext clauseGenerationContext)
    {
      return (ResultOperatorBase) new LastResultOperator(this.ParsedExpression.Method.Name.EndsWith("OrDefault"));
    }
  }
}
