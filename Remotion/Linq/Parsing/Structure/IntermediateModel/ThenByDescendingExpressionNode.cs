...
namespace Remotion.Linq.Parsing.Structure.IntermediateModel
{
  ...
  public sealed class ThenByDescendingExpressionNode : MethodCallExpressionNodeBase
  {
    ...
    public static IEnumerable<MethodInfo> GetSupportedMethods() => ReflectionUtility.EnumerableAndQueryableMethods.WhereNameMatches("ThenByDescending").WithoutComparer();
      ...
      ClauseGenerationContext clauseGenerationContext)
    {
      ...
      (this.GetOrderByClause(queryModel) ?? throw new NotSupportedException("ThenByDescending expressions must follow OrderBy, OrderByDescending, ThenBy, or ThenByDescending expressions.")).Orderings.Add(new Ordering(this.GetResolvedKeySelector(clauseGenerationContext), OrderingDirection.Desc));
    }
