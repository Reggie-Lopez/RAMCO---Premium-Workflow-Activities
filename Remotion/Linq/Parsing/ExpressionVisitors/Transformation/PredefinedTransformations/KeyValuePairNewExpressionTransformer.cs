...
// Type: Remotion.Linq.Parsing.ExpressionVisitors.Transformation.PredefinedTransformations.KeyValuePairNewExpressionTransformer
...
namespace Remotion.Linq.Parsing.ExpressionVisitors.Transformation.PredefinedTransformations
{
  ...
  public class KeyValuePairNewExpressionTransformer : MemberAddingNewExpressionTransformerBase
  {
    ...
    protected override bool CanAddMembers(
      ...
      ReadOnlyCollection<Expression> arguments)
    {
      return instantiatedType.Name == typeof (KeyValuePair<,>).Name && instantiatedType.Namespace == typeof (KeyValuePair<,>).Namespace && arguments.Count == 2;
    }
  }
}
