...
// Type: Remotion.Linq.Parsing.ExpressionVisitors.MemberBindings.FieldInfoBinding
...
namespace Remotion.Linq.Parsing.ExpressionVisitors.MemberBindings
{
  ...
  public class FieldInfoBinding : MemberBinding
  {
    ...
    public override bool MatchesReadAccess(MemberInfo member) => member == this.BoundMember;
  }
}
